...
func FromMap[K comparable, V any](inputMap map[K]V) *SafeMap[K, V] {
	myMap := &SafeMap[K, V]{}
...
func (m *SafeMap[K, V]) Fold(initialValue interface{}, folder func(accumulator interface{}, key K, value V) interface{}) interface{} {
